...
SearchDataDictionary <- function(DataDictionaryList, QueryString){
  ...
  # this case supports multiple string matching; mainly to be used with filtering out data from 
  # ReadRedcapData.R::read_projects
  # cannot do multiple string matching within fixed function!?
  ...
  # View each sub data dicationary
